...
// text = text.replace(gl[i], ""); //находит в тек��те гла��ну�� и замен��ет её
// на пу��тое ме��то
// }
...
// Дан ма����ив целых чи��ел и ещё одно целое чи��ло. Удалите в��е вхождени��
// ��того чи��ла из ма����ива
...
// // ��апи��ите программу, котора�� выводит на кон��ол�� про��тые чи��ла в
// промежутке от [2, 100].
// // ����пол��зуйте дл�� ре��ени�� ��той задачи оператор "%" (о��таток от
// делени��) и циклы.
// public class my_exe {
...
// //Заполните ма����ив ��лучайным чи��лами и выведите мак��имал��ное,
// минимал��ное и ��реднее значение.
// public class my_exe {
